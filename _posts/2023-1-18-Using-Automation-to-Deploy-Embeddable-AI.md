...
---
In a previous blog [introducing IBM Watson for Embed]({{"/article/2023-1-2-Introducing-IBM-Watson-for-Embed" | relative_url }}), I introduced the IBM Watson Libraries for Embed.  They provide a common framework to help ISVs embed AI including natural language processing (NLP) and speech into their solutions.
